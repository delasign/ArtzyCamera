...
vertex Vertex backwardStrokeVertexShader(VertexInput in [[ stage_in ]],
...
fragment half4 backwardStrokeSurfaceFragment(Vertex in [[stage_in]],
                                     constant SCNSceneBuffer& scn_frame [[buffer(0)]],
                                     constant NodeBuffer& scn_node [[buffer(1)]],
                                     ...
                                     sampler texSampler [[sampler(0)]])
{
    ...
    if (in.uv.y > timer/milestoneTimeBreadth) {
        discard_fragment();
    }
