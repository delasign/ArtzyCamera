...
//  Artzy
//
//  Created by Oscar De la Hera Gomez on 11/19/18.
...
vertex Vertex BackwardsTimedStrokeTextureVertexShader(VertexInput in [[ stage_in ]],
...
fragment half4 BackwardsTimedStrokeTextureSurfaceFragment(Vertex in [[stage_in]],
                                                 constant SCNSceneBuffer& scn_frame [[buffer(0)]],
                                                 constant NodeBuffer& scn_node [[buffer(1)]],
